...
#include "ADCoupledFluxBC.h"

registerMooseObject("MooseApp", ADCoupledFluxBC);

InputParameters
ADCoupledFluxBC::validParams()
{
...
ADCoupledFluxBC::ADCoupledFluxBC(const InputParameters & parameters)
...
ADReal
ADCoupledFluxBC::computeQpResidual()
{
