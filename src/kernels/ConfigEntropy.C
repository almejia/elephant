...
validParams<ConfigEntropy>()
{
  ...
  params.addParam<Real>("n", 4.1488e4,"Cation site density (ny). Default is 41488 = 4/(avnum*latpar^3)." );

  return params;
}

ConfigEntropy::ConfigEntropy(const InputParameters & parameters) : Kernel(parameters),
