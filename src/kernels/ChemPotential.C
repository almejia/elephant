...
#include "ChemPotential.h"

registerMooseObject("MooseApp", ChemPotential);

template <>
InputParameters
validParams<ChemPotential>()
{
...
ChemPotential::ChemPotential(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
ChemPotential::computeQpResidual()
{
...
Real
ChemPotential::computeQpJacobian()
{
...
Real
ChemPotential::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (jvar == _c_var)
  {
